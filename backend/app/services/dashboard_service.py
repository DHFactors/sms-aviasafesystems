...
from app.db.db_models import FlightDiversion, Hazard, Report, StateRiskRegisterEntry, Survey, SurveyResponse, Tenant
...
class DashboardService:
    ...
    _SEED_TAXONOMY = {
        "bird strike": "Environmental",
        "bird activity": "Environmental",
        "runway incursion": "Organizational",
        "runway excursion": "Organizational",
        "abnormal runway contact": "Organizational",
        "ground collision": "Organizational",
        "airborne conflict": "Organizational",
        "atc operational incident": "Organizational",
        "procedural deviation": "Organizational",
        "sop deviation": "Organizational",
