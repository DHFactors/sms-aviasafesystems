...
- [ ] Administration section shows:
  - Survey Rate Limit control
  - Authorized Users list
  - Survey Instructions editor
...
### Report Flow
- [ ] Submit a VSR
- [ ] Check Hazard Register for auto-created hazard
- [ ] Issue CAN from hazard
- [ ] Create CAP from CAN
- [ ] Complete CAP → CAN auto-closes